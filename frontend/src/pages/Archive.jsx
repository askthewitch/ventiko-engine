...
function Archive() {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        const res = await axios.get('https://ventiko-engine-backend.onrender.com/archive');
  ...
  // --- GEO INTELLIGENCE GENERATOR ---
  // This turns your search data into "Question & Answer" Schema for Google AI
  const generateSchema = () => {
    ...
    const schema = {
      ...
      "@type": "FAQPage",
      "mainEntity": archiveData.map(log => ({
        "@type": "Question",
        "name": `What are the best products for ${log.query}?`, // CHANGED: Updated branding here
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Ventiko AI suggests: ${log.results_summary}.`
        }
      }))
    };
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      {/* SEO & GEO INJECTION */}
      <Helmet>
        <title>Live Archive | Ventiko Real-Time Search Trends</title> {/* CHANGED: Fixed typo Venitko -> Ventiko */}
        <meta name="description" content="See what others are finding with Ventiko. Real-time product search results powered by our AI engine." />
        <link rel="canonical" href="https://ventiko.app/archive" />
