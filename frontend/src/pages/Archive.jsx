...
function Archive() {
  ...
  const generateSchema = () => {
    ...
    const schema = {
      ...
      "mainEntity": archiveData.map(log => ({
        "@type": "Question",
        "name": `What is the protocol for ${log.query}?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Ventiko analysis suggests: ${log.results_summary}.`
        }
      }))
    };
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      {/* SEO & GEO INJECTION */}
      <Helmet>
        <title>Live Archive | Ventiko Protocols</title>
        <meta name="description" content="Real-time bio-optimization protocols generated by the Ventiko Engine. See what others are optimizing for." />
